...
const PairingCard:React.FC<PairingCardProps> = ({item,index}) => {
  ...
  return (
    ...
    ${pairingItems.length == 2 && 'w-[420px] h-[210px] flex-row gap-3 p-[14px]'}
    ${pairingItems.length == 3 && 'w-[315px] h-[205px] flex-row gap-3 p-[13px]'}
    ${pairingItems.length == 4 && 'w-[180px] h-[340px] flex-col gap-5 p-[17px]'}
    ${pairingItems.length == 5 && 'w-[165px] h-[320px] flex-col gap-3 p-[12px]'}
    ${pairingItems.length == 6 && 'w-[310px] h-[165px] flex-row gap-3 p-[9px]'}
    ${pairingItems.length == 8 && 'w-[240px] h-[165px] flex-row gap-2 p-[7px]'}
